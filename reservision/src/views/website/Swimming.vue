...
const revealEnrollmentForm = () => { showEnrollmentForm.value = true; document.body.style.overflow = 'hidden' }
const closeEnrollmentForm = () => { showEnrollmentForm.value = false; document.body.style.overflow = '' }
const openClassBookingModal = (lessonType = '') => { classBookingForm.lessonType = lessonType || ''; classBookingError.value = ''; showClassBookingModal.value = true; document.body.style.overflow = 'hidden' }
const closeClassBookingModal = () => { showClassBookingModal.value = false; document.body.style.overflow = '' }
